...
if ($dat_zaistenia && $utvar && $cvs && $trieda  && $kurier OR $osobne && $vazba && $skoda && $utvar_dopyt && $dopyt_cislo
  ...
  OR $cislo_ps2 OR $ps2 OR $porozita_ps2 OR $kl_ps2_cas OR $miesto_ps2 OR $podmienky_ps2 OR $teplota_ps2) { /// <- to je pre päť stôp
  ...
  porozita_ps2, kl_ps2_cas, miesto_ps2, podmienky_ps2, teplota_ps2)
