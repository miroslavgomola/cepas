...
if (isset($_POST['odoslat'])) {
  ...
  $cislo_ps4 = $_POST['cislo_ps4'];
  $cislo_ps5 = $_POST['cislo_ps5'];
  $ps2 = $_POST['ps2'];
  $ps3 = $_POST['ps3'];
  $ps4 = $_POST['ps4'];
  $ps5 = $_POST['ps5'];
  ...
  $kl_ps4_cas = $_POST['kl_ps4_cas'];
  $kl_ps5_cas = $_POST['kl_ps5_cas'];
  $miesto_ps2 = $_POST['miesto_ps2'];
  $miesto_ps3 = $_POST['miesto_ps3'];
  $miesto_ps4 = $_POST['miesto_ps4'];
  $miesto_ps5 = $_POST['miesto_ps5'];
  $podmienky_ps2 = $_POST['podmienky_ps2'];
  $podmienky_ps3 = $_POST['podmienky_ps3'];
  $podmienky_ps4 = $_POST['podmienky_ps4'];
  $podmienky_ps5 = $_POST['podmienky_ps5'];
  $teplota_ps2 = $_POST['teplota_ps2'];
  $teplota_ps3 = $_POST['teplota_ps3'];
  $teplota_ps4 = $_POST['teplota_ps4'];
  $teplota_ps5 = $_POST['teplota_ps5'];
  $porozita_ps2 = $_POST['porozita_ps2'];
  $porozita_ps3 = $_POST['porozita_ps3'];
  $porozita_ps4 = $_POST['porozita_ps4'];
  $porozita_ps5 = $_POST['porozita_ps5'];
  $stupen = $_POST['stupen'];
...
if ($dat_zaistenia && $utvar && $cvs && $trieda  && $kurier OR $osobne && $vazba && $skoda && $utvar_dopyt && $dopyt_cislo
  ...
  OR $cislo_ps3 OR $ps3 OR $porozita_ps3 OR $kl_ps3_cas OR $miesto_ps3 OR $podmienky_ps3 OR $teplota_ps3
  OR $cislo_ps4 OR $ps4 OR $porozita_ps3 OR $kl_ps4_cas OR $miesto_ps4 OR $podmienky_ps4 OR $teplota_ps4
  OR $cislo_ps5 OR $ps5 OR $porozita_ps5 OR $kl_ps5_cas OR $miesto_ps5 OR $podmienky_ps5 OR $teplota_ps5) { /// <- to je pre päť stôp
  ...
  cislo_ps4, ps4, porozita_ps4, kl_ps4_cas, miesto_ps4, podmienky_ps4, teplota_ps4, cislo_ps5, ps5, porozita_ps5, kl_ps5_cas, miesto_ps5, podmienky_ps5, teplota_ps5)
  ...
  '$miesto_ps3', '$podmienky_ps3', '$teplota_ps3', '$cislo_ps4', '$ps4', '$porozita_ps4', '$kl_ps4_cas', '$miesto_ps4', '$podmienky_ps4', '$teplota_ps4',
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  ...
  <body>
    ...
    <div style="font-size:14pt;"><fieldset class="frame">
    Číslo PS:&nbsp<input type="text"  class="frame" style="height:30px;width:30px;font-size:14pt;" name="cislo_ps4" value="<?php if (isset($_POST['cislo_ps4'])) echo $_POST['cislo_ps4']; ?>">
    Miesto zaistenia PS:&nbsp<input type="text"  class="frame" style="height:30px;width:400px;font-size:14pt;" name="ps4" value="<?php if (isset($_POST['ps4'])) echo $_POST['ps4']; ?>">&nbsp
    Absorbent PORÓZNY:&nbsp<select class="frame" style="height:30px;font-size:14pt;" name="porozita_ps4" value="<?php if (isset($_POST['porozita_ps4'])) echo $_POST['porozita_ps4']; ?>"/><br>
      <option></option>
      <option>ÁNO</option>
      <option>NIE</option></select><p style="font-size:12pt;">
    Časový úsek po zaistenie PS:&nbsp<select class="frame" style="height:30px;font-size:12pt;" name="kl_ps4_cas" value="<?php if (isset($_POST['kl_ps4_cas'])) echo $_POST['kl_ps4_cas']; ?>"/>
      <option></option>
      <option>Do 24 hod.</option>
      <option>Do 48 hod.</option>
      <option>Nad 48 hod.</option></select>
    Miesto zaistenia:&nbsp<select class="frame" style="height:30px;font-size:12pt;" name="miesto_ps4" value="<?php if (isset($_POST['miesto_ps4'])) echo $_POST['miesto_ps4']; ?>"/>
      <option></option>
      <option>Interér</option>
      <option>Exteriér</option></select>
    Poveternostné podmienky:&nbsp<select class="frame" style="height:30px;font-size:12pt;" name="podmienky_ps4" value="<?php if (isset($_POST['podmienky_ps4'])) echo $_POST['podmienky_ps4']; ?>"/>
      <option></option>
      <option>Chladno</option>
      <option>Sucho</option>
      <option>Dážď</option></select>
    Teplota:&nbsp<input type="text" class="frame" style="height:30px;width:30px;font-size:12pt;" name="teplota_ps4" value="<?php if (isset($_POST['teplota_ps4'])) echo $_POST['teplota_ps4']; ?>">
    &nbsp°C</fieldset></div>

    <div style="font-size:14pt;"><fieldset class="frame">
    Číslo PS:&nbsp<input type="text"  class="frame" style="height:30px;width:30px;font-size:14pt;" name="cislo_ps5" value="<?php if (isset($_POST['cislo_ps5'])) echo $_POST['cislo_ps5']; ?>">
    Miesto zaistenia PS:&nbsp<input type="text"  class="frame" style="height:30px;width:400px;font-size:14pt;" name="ps5" value="<?php if (isset($_POST['ps5'])) echo $_POST['ps5']; ?>">&nbsp
    Absorbent PORÓZNY:&nbsp<select class="frame" style="height:30px;font-size:14pt;" name="porozita_ps5" value="<?php if (isset($_POST['porozita_ps5'])) echo $_POST['porozita_ps5']; ?>"/><br>
      <option></option>
      <option>ÁNO</option>
      <option>NIE</option></select><p style="font-size:12pt;">
    Časový úsek po zaistenie PS:&nbsp<select class="frame" style="height:30px;font-size:12pt;" name="kl_ps5_cas" value="<?php if (isset($_POST['kl_ps5_cas'])) echo $_POST['kl_ps5_cas']; ?>"/>
      <option></option>
      <option>Do 24 hod.</option>
      <option>Do 48 hod.</option>
      <option>Nad 48 hod.</option></select>
    Miesto zaistenia:&nbsp<select class="frame" style="height:30px;font-size:12pt;" name="miesto_ps5" value="<?php if (isset($_POST['miesto_ps5'])) echo $_POST['miesto_ps5']; ?>"/>
      <option></option>
      <option>Interér</option>
      <option>Exteriér</option></select>
    Poveternostné podmienky:&nbsp<select class="frame" style="height:30px;font-size:12pt;" name="podmienky_ps5" value="<?php if (isset($_POST['podmienky_ps5'])) echo $_POST['podmienky_ps5']; ?>"/>
      <option></option>
      <option>Chladno</option>
      <option>Sucho</option>
      <option>Dážď</option></select>
    Teplota:&nbsp<input type="text" class="frame" style="height:30px;width:30px;font-size:12pt;" name="teplota_ps5" value="<?php if (isset($_POST['teplota_ps5'])) echo $_POST['teplota_ps5']; ?>">
    &nbsp°C</fieldset></div><br>
    <div>RUŠIVÉ VPLYVY:&nbsp<input type="text"  class="frame" style="height:30px;width:400px;font-size:14pt;" name="rusive_vplyvy"
      value="<?php if (isset($_POST['rusive_vplyvy'])) echo $_POST['rusive_vplyvy']; ?>">&nbsp
    STUPEŇ:&nbsp<select class="frame" style="height:30px;font-size:12pt;" name="stupen" value="<?php if (isset($_POST['stupen'])) echo $_POST['stupen']; ?>"/>
      <option></option>
      <option>1</option>
      <option>2</option></select></div><br>
    <div style="font-size:14pt;">POPIS SKUTKU <br><b style="font-size:10pt;">Dátum a čas spáchania trestného činu, kto, čo, miesto a stručná charakteristika.<b><p>
    <input type="text" style="font-size:12pt;width:800px;height:30px;" class="frame" rows="6" cols="100" name="popis" value="<?php if (isset($_POST['popis'])) echo $_POST['popis']; ?>">
    </input></div><br>
